...
| Case | Prefill tokens | Decode tokens | Prefill | Decode TPS | 说明 |
| --- | ---: | ---: | ---: | ---: | --- |
| short_short | 1 | 7 | 最新 smoke 约 2.05s | 2.59 tok/s | `PD_CASE=short_short` smoke |
| short_short | 1 | 7 | 约 4.04s | 2.67 tok/s | active GPU MoE 的 prior all-case run |
| short_long | 1 | 9 | 约 4.67s | 2.71 tok/s | active GPU MoE 的 prior all-case run |
| long_short | ~2k | 7 | 约 14.00s | 2.73 tok/s | active GPU MoE 的 prior all-case run |
| long_long | ~2k | 63 | 约 12.75s | 2.64 tok/s | active GPU MoE 的 prior all-case run |
